...
Version **3.0.0** supports relapses, improvement, and multiple event annotation. In addition, it contains a few minor bug fixes, and the implementation was fully refactored, so this version should be used for all further analyses.
