...
def plot_annotated_follow_up(
    ...
    used_as_raw_pira_reference_score_column_name="edss_score_used_as_new_raw_pira_reference",
            ...
            baseline_specs_dict_list = baseline_specs_dict_list + [
                {
                    ...
                    "score": used_as_raw_pira_reference_score_column_name,
...
def annotate_plot_follow_up(
    ...
    progression_finder = edssprogression.EDSSProgression(
        ...
        used_as_raw_pira_reference_score_column_name=used_as_raw_pira_reference_score_column_name,
